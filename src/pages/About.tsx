...
import { ChevronRight, LineChart, Brain, Clock, Trophy } from 'lucide-react';
    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="py-16 px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link 
            to="/daily" 
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary-600 hover:bg-primary-700 text-white font-medium transition-all transform hover:translate-y-[-2px] shadow-md hover:shadow-lg"
          >
            Play Today's Game
          ...
          <Link 
            to="/practice" 
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white dark:bg-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-900 dark:text-neutral-50 font-medium border border-neutral-200 dark:border-neutral-700 transition-all transform hover:translate-y-[-2px] shadow-sm hover:shadow"
          >
            Practice Mode
            <ChevronRight size={18} />
          </Link>
